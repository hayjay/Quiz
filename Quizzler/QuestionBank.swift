...
//  Quizzler
//
//  Created by new on 22/05/2019.
//  Copyright © 2019 London App Brewery. All rights reserved.
//s

import Foundation

//the purpose of this class is to store all of the questions we gonna have in this quiz app
class QuestionBank {
    //create a property list that contains an array of question
    var list = [Question]()
    
    init(){
        //basically instantiating new Question class and passing the parameter
        
        // Creating a quiz item and appending it to the list
        let item = Question(text: "Valentine\'s day is banned in Saudi Arabia. Yes or No ?", correctAnswer: true)
        
        // Add the Question to the list of questions //push data to the list array
        list.append(item)
